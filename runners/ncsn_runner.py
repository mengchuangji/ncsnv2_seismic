...
class NCSNRunner():
    ...
    def train(self):
        ...
        # dataloaders = []
        # from datasets.seis_mat import SeisMatTrainDataset
        # train_set = SeisMatTrainDataset(path='"D:\\datasets\\seismic\\marmousi\\f35_s256_o128"',
        ...
        #
        # test_loaders = []
        # test_set = SeisMatTrainDataset(path='"D:\\datasets\\seismic\\marmousi\\f35_s256_o128"',
        #                                 patch_size=128, pin_memory=True)
        # test_loader = DataLoader(test_set, batch_size=self.config.training.batch_size, shuffle=True,
        #                           num_workers=0, drop_last=True)
        ...
        for epoch in range(start_epoch, self.config.training.n_epochs):
            ...
            # for i, (X, y) in enumerate(dataloaders[0]):
                score.train()
                step += 1
