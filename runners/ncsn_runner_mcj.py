...
class NCSNRunner():
    ...
    def train(self):
        ...
        train_set = SeisMatTrainDataset_clean(path='/home/shendi_mcj/datasets/seismic/marmousi/R_s256_o128',
        ...
        test_loaders = []
        test_set = SeisMatValidationDataset_clean(path='/home/shendi_mcj/datasets/seismic/marmousi/R_s256_o128',
        ...
        logging.info("config.model.sigma_begin: {}".format(self.config.model.sigma_begin))
        logging.info("num_classes: {}".format(self.config.model.num_classes))
            ...
            if self.config.sampling.inpainting:
                ...
                if not self.config.sampling.final_only:
                    ...
                    plt.savefig(os.path.join(os.path.join(self.args.image_folder,
                                                          'image_grid_{}_gener_1.png'.format(
                                                              self.config.sampling.ckpt_id))),
                                format='jpg',
                                dpi=300, bbox_inches='tight')
                    torch.save(sample, os.path.join(self.args.image_folder,
                                                    'samples_{}_gener_1.pth'.format(self.config.sampling.ckpt_id)))
                    ...
                    # # plt.colorbar()  # 添加色标
                    # plt.axis('off')  # 关闭坐标轴
                    # plt.savefig(os.path.join(self.args.image_folder, 'stochastic_variation_x_t.png'), format='jpg',
                    #             dpi=300,
                    #             bbox_inches='tight')
