...
GT = glob.glob(os.path.join('/home/shendi_mcj/datasets/seismic/marmousi', '*R.mat'))
...
out_dir = "/home/shendi_mcj/datasets/seismic/marmousi/R_s256_o128_NM"
...
for ii in range(len(GT)):
    ...
    # H, W= im_noisy.shape
    im_gt = sio.loadmat(GT[ii])['R']  # [:, :, ::-1]
    im_gt=im_gt/abs(im_gt).max()
    H, W = im_gt.shape
