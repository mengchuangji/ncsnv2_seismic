...
from runners.ncsn_runner_mcj_mms_vp_den import *
# from runners.ncsn_runner_mcj import *
...
def parse_args_and_config():
    ...
    parser.add_argument('--doc', type=str, default='marmousi_vp_den', help='A string for documentation purpose. '
...
def main():
    ...
    config.sampling.n_interpolations=15
    args.doc = 'marmousi'
