...
def parse_args_and_config():
    ...
    parser.add_argument('--config', type=str, default='celeba.yml',  help='Path to the config file') #celeba.yml
    parser.add_argument('--seed', type=int, default=1234, help='Random seed')
    parser.add_argument('--exp', type=str, default='exp', help='Path for saving running related data.')
    parser.add_argument('--exp_my', type=str, default='D:\\', help='Path for saving running related data.')
    parser.add_argument('--doc', type=str, default='celeba_test', help='A string for documentation purpose. '
    ...
    parser.add_argument('--sample', default=True, help='Whether to produce samples from the model')
