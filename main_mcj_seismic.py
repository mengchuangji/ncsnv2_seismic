...
import copy
from runners.ncsn_runner_mcj import *
...
def parse_args_and_config():
    ...
    parser.add_argument('--doc', type=str, default='marmousi_3', help='A string for documentation purpose. '
    ...
    parser.add_argument('--resume_training', default=True, help='Whether to resume training')
...
def main():
    ...
    #These hyperparameters are already set in the config file. Here are the key hyperparameters for easy browsing. In addition, the automatic calculation of these hyperparameters is in the ncsn_runner_mcj file and the ncsn_runner_mcj_mms_segy file.

    # args.resume_training=True   # True: if you want to continue training
    # args.resume_ckpt_id=95000   # The ckpt_id when continuing training
    config.data.image_size = 128
    config.data.seis_rescaled = True  # If true, seismic data is normalized to the interval [0,1], otherwise to the interval [-1,1]
